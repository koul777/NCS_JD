...
const FIELD_ALIASES = new Map([
  ...
  ["직무명", "채용분야"], ["직무", "채용분야"], ["근무분야", "채용분야"], ["채용직무", "채용분야"], ["채용직무명", "채용분야"],
  ["대분류", "대분류"], ["중분류", "중분류"], ["소분류", "소분류"], ["세분류", "세분류"],
  ["능력단위", "능력단위"], ["역량단위", "능력단위"],
  ["직무수행내용", "직무수행내용"], ["담당업무", "직무수행내용"],
  ["수행업무", "직무수행내용"], ["주요업무", "직무수행내용"],
  ["직무내용", "직무수행내용"], ["업무내용", "직무수행내용"], ["주요과업", "직무수행내용"],
  ...
  ["응시자격", "필요자격"], ["응시자격요건", "필요자격"], ["학력요건", "필요자격"], ["경력요건", "필요자격"],
  ["지원자격", "필요자격"], ["자격조건", "필요자격"], ["지원요건", "필요자격"],
